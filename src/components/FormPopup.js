  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      {/* <img src={Logo} className="logo_landing" alt="logo"/> */}
        <h1 class="modal-title fs-5" id="exampleModalToggleLabel">Website Design Zilla</h1>
        
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
    <form onSubmit={submitHandler}>
        <div className='pop_form'>
        <p>Please Provide the following information so our agent will contatc you within 24 working hours</p>
            <div className='row'>
            <div className='col-md-6'>
                <div className="form-floating">
                    <input type="text" className="form-control" id="floatingInput" placeholder="Your name" required name="name" onChange={changeHandler} />
