                ...
                <div className="col-md-12">
                  <div className="aligncenter">
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <p className="large">
                          I was a bit confused when I got to LDH, and the
                          excellent team helped us along the way! We’re more
                          than happy working with them..!
                        </p>
                ...
                <div className="col-md-12">
                  <div className="aligncenter">
                    <div className="row">
                      ...
                      >
                        <p className="large">
                          Received my project on time and provided me proper
                          assistance along the way. Loved working with them! .
                        </p>
