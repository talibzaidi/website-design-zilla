...
function Home() {
  ...
  return (
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="home1heading">
                  <h1 className=" mb15" style={{ color: "white" }}>
                    Get Custom website Development
                  </h1>
                  <p
                    style={{ color: "white", width: "70%", marginLeft: "14%" }}
                    className="mb40 large"
                  >
                    We serve businesses, start-ups, and organizations to
                    engender fresh initiatives. and create customer-friendly
                    branding, websites, tools, and apps.
                  </p>
                  <div className="Button_margin">
                    <button
                      className="btn7 rounded "
                      data-bs-toggle="modal"
                      data-bs-target="#exampleModalToggle"
                    >
                      <span className="text-green">Sign Up Now</span>
                    </button>
                    <a href="javascript:$zopim.livechat.window.show();">
                      <button className="btn7 rounded ">
                        <span className="text-green">Live Discuss</span>
                      </button>
                    </a>
                  </div>
                </div>
    ...
    <li></li> */}
                    <li>
                      <a
                        href="https://twitter.com/ZillaWebsite"
                    ...
                    <li>
                      <a
                        href="https://www.facebook.com/WebsiteDesignZilla/"
                        rel="noopener noreferrer"
                        target="_blank"
                      >
                    ...
                    <li>
                      <a
                        href="https://www.linkedin.com/company/website-design-zilla"
                        rel="noopener noreferrer"
                        target="_blank"
                      >
      ...
      <div className="cookie1" id="c1">
        <p>
          ...
          <button onClick={() => f1()}>ACCEPT</button>
        </p>
      </div>
      {/*END-cookie popup*/}
    </div>
